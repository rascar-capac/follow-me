...
Shader "_SheeroChana/CliffShader"
{
	...
	SubShader
	{
		...
		uniform float4 _MeshNormal_ST;
		uniform float _Bottom_NormalScale;
		uniform sampler2D _Bottom_Normal;
		uniform float2 _Tilling;
		uniform float _TriplanarFalloff;
		uniform float _Top_NormalScale;
		uniform sampler2D _Top_Normal;
		uniform sampler2D _Bottom_Albedo;
		...
		{
			float2 uv_MeshNormal = i.uv_texcoord * _MeshNormal_ST.xy + _MeshNormal_ST.zw;
			...
			float3 lerpResult84 = lerp( UnpackScaleNormal( tex2D( _Bottom_Normal, ProjectionSideXY63 ), _Bottom_NormalScale ) , UnpackNormal( tex2D( _Bottom_Normal, ProjectionSideYZ64 ) ) , NormalAbsX68);
			...
			float3 lerpResult85 = lerp( UnpackNormal( tex2D( _Bottom_Normal, ProjectionTopXZ65 ) ) , UnpackScaleNormal( tex2D( _Top_Normal, ProjectionTopXZ65 ), _Top_NormalScale ) , NormalZ70);
			...
			float3 normalizeResult99 = normalize( ( UnpackNormal( tex2D( _MeshNormal, uv_MeshNormal ) ) + lerpResult79 ) );
			o.Normal = normalizeResult99;
			float4 lerpResult40 = lerp( tex2D( _Bottom_Albedo, ProjectionSideXY63 ) , tex2D( _Bottom_Albedo, ProjectionSideYZ64 ) , NormalAbsX68);
			float4 lerpResult51 = lerp( tex2D( _Bottom_Albedo, ProjectionTopXZ65 ) , tex2D( _Top_Albedo, ProjectionTopXZ65 ) , NormalZ70);
...
/*ASEBEGIN
Version=17500
23;118;1899;843;4528.116;790.0103;1.3;True;False
Node;AmplifyShaderEditor.CommentaryNode;91;-4786.352,-1443.332;Inherit;False;3506.142;2527.924;Comment;12;61;60;75;74;64;65;63;70;89;90;68;69;DetailMap;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.Vector2Node;27;-4269.486,-749.7354;Inherit;False;Property;_Tilling;Tilling;8;0;Create;True;0;0;False;0;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;59;-4025.246,-243.0952;Inherit;False;Property;_TriplanarFalloff;TriplanarFalloff;9;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;57;-3743.896,-189.6821;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;90;-3034.461,746.9781;Inherit;False;Property;_Top_NormalScale;Top_NormalScale;7;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;89;-3045.461,394.9781;Inherit;False;Property;_Bottom_NormalScale;Bottom_NormalScale;4;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;80;-2462.565,158.703;Inherit;True;Property;_Bottom_Normal;Bottom_Normal;3;0;Create;True;0;0;False;0;-1;2e0ae9eb0cfb950488818dd979f958b7;2e0ae9eb0cfb950488818dd979f958b7;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;76;-2463.494,358.7892;Inherit;True;Property;_TextureSample4;Texture Sample 4;3;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;True;Instance;80;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;78;-2472.494,613.7892;Inherit;True;Property;_TextureSample5;Texture Sample 5;3;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;True;Instance;80;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;77;-2499.78,854.593;Inherit;True;Property;_Top_Normal;Top_Normal;6;0;Create;True;0;0;False;0;-1;ccc652a56e4f8394b8aade5d45837f4b;ccc652a56e4f8394b8aade5d45837f4b;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;50;-2663.745,-534.0251;Inherit;True;Property;_Top_Albedo;Top_Albedo;5;0;Create;True;0;0;False;0;-1;99e0ab75521fdcc4985745d7b62a8f81;99e0ab75521fdcc4985745d7b62a8f81;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;92;-953.7856,-2.742428;Inherit;True;Property;_MeshNormal;MeshNormal;0;0;Create;True;0;0;False;0;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;3;-2629.946,-1238.05;Inherit;True;Property;_Bottom_Albedo;Bottom_Albedo;2;0;Create;True;0;0;False;0;-1;0f99824124a559a4497b267fceb66a69;0f99824124a559a4497b267fceb66a69;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;93;-953.0416,-212.6348;Inherit;True;Property;_Mesh_AO;Mesh_AO;1;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-398.4815,284.7939;Inherit;False;Property;_Metallic;Metallic;10;0;Create;True;0;0;False;0;0.6485723;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-405.1042,376.9467;Inherit;False;Property;_Smoothness;Smoothness;11;0;Create;True;0;0;False;0;0.7037836;0;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=37F1ED9E91D5310FB93D307EBE2981F383804706