...
Shader "_SheeroChana/DayNight_Foliage"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			float4 lerpResult79 = lerp( ( tex2D( _Day_Texture, uv_Day_Texture ) * _DayColor ) , ( tex2D( _Night_Texture, uv_Night_Texture ) * _NightColor ) , _DayNightAlbedo);
...
/*ASEBEGIN
Version=17500
3;59;1834;910;5179.683;1383.566;3.463492;True;True
...
ASEEND*/
//CHKSM=9EFB66F82C94597CD5DE8B654DE60434AEF3A5B6